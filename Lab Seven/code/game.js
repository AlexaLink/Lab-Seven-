...
function Star(pos) {
  this.base.Pos = this.pos = pos.plus(new Vector(0.2, 0.1));
...
Star.prototype.act = function(step) {
  this.sparkle += step * sparkleSpeed;
  var sparklePos = Math.sin(this.sparkle) * sparkleDist;
  this.pos = this.basePos.plus(new Vector(0, sparklePos));
};
var maxStep = 0.05;
